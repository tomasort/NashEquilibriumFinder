...
def prisoners_dilemma():
    ...
    game.grid = [[(3, 3), (0, 5)], [(5, 0), (1, 1)]]

    # Set up the grid_pure_nash with the same values
    game.grid_pure_nash = [[(3, 3), (0, 5)], [(5, 0), (1, 1)]]
...
def coordination_game():
    ...
    game.grid = [[(5, 5), (0, 0)], [(0, 0), (3, 3)]]

    # Set up the grid_pure_nash with the same values
    game.grid_pure_nash = [[(5, 5), (0, 0)], [(0, 0), (3, 3)]]
...
def battle_of_sexes():
    ...
    # Set up the grid manually
    game.grid = [[(3, 2), (0, 0)], [(0, 0), (2, 3)]]

    # Set up the grid_pure_nash with the same values
    game.grid_pure_nash = [[(3, 2), (0, 0)], [(0, 0), (2, 3)]]
...
def zero_sum_game():
    ...
    # Set up the grid manually
    game.grid = [[(5, -5), (-3, 3)], [(-2, 2), (4, -4)]]

    # Set up the grid_pure_nash with the same values
    game.grid_pure_nash = [[(5, -5), (-3, 3)], [(-2, 2), (4, -4)]]
...
def dominated_strategy_game():
    ...
    # Set up the grid manually
    game.grid = [[(5, 1), (3, 0)], [(3, 2), (2, 1)]]

    # Set up the grid_pure_nash with the same values
    game.grid_pure_nash = [[(5, 1), (3, 0)], [(3, 2), (2, 1)]]
