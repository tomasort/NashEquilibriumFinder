...
import json
from normal_form.NormalForm import NormalForm, create_prisoners_dilemma, create_coordination_game, \
    create_battle_of_sexes, create_zero_sum_game
...
class GameManager:
    ...
    def create_game(self, mode, rows=None, columns=None, payoff_matrix=None, 
                   lower_limit=-99, upper_limit=99):
        """Create a new game.
        ...
        """
        game = NormalForm(mode=mode, rows=rows, columns=columns, 
