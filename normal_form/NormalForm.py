...
class NormalForm():
    ...
    def get_indifference_probabilities(self, check_pure_nash=True):
        ...
        if denominator1 != 0:
            ...
            result['error'] = "Division by zero when calculating Player 1's strategy. One or more strategies may be dominated."
            return result
        ...
        if denominator2 != 0:
            ...
            result['error'] = "Division by zero when calculating Player 2's strategy. One or more strategies may be dominated."
            return result
